...
Private class, used to match rules. Initialized with a "raw matcher", which can be:
  ...
  - An object with `action`, `loader`, or `resource` and `loaderType`
  ...
  - A resource path string
        examples:
            ...
            "styles.css"  -  resolved relative to process.cwd()
...
class RuleMatcher {
    ...
    @param {object|function|string} rawMatcher to match against
      ...
      @property {string} resource resource path, resolved to appSrc path
    */
